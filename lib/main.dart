  ...
  try {
    ...
    if (defaultTargetPlatform != TargetPlatform.linux) {
      ...
      await Firebase.initializeApp(
        ...
        onTimeout: () {
          throw Exception(
            'Firebase initialization timed out - check network connection',
          );
        },
      );
      ...
      try {
        await FirebaseAppCheck.instance
            ...
            .timeout(
              ...
              onTimeout: () {
                debugPrint(
                  'App Check initialization timed out - continuing without it',
                );
                return;
              },
            );
    ...
    if (e.toString().contains('network') ||
      ...
      debugPrint(
        'Network connectivity issue detected - running in offline mode',
      );
    }
  }
